...
#include <string.h>
#include <getopt.h>
#include "../../hw2/include/version.h"
#include "../../hw2/include/global.h"
#include "../../hw2/include/gradedb.h"
#include "../../hw2/include/stats.h"
#include "../../hw2/include/read.h"
#include "../../hw2/include/write.h"
#include "../../hw2/include/normal.h"
...
char *argv[];
{
        ...
        if(c != NULL && c->roster != NULL)checkfordups(c->roster);
        if(collate) {
